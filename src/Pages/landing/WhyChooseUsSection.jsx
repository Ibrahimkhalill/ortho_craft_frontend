        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="space-y-6 sm:space-y-8 lg:space-y-10 text-center lg:text-left">
            ...
            <div className="inline-flex">
              <span className="px-4 sm:px-5 py-2 rounded-full bg-[#E6F5FF] text-[#009FF2] text-sm font-semibold border border-[#BCE3FA]">
                Why Choose Us
              </span>
            </div>

            {/* Main Heading */}
            <h2 className="text-2xl sm:text-3xl md:text-4xl  text-left  font-bold text-gray-900 leading-tight">
            ...
            {/* Description */}
            <p className="text-gray-600 text-base sm:text-lg leading-relaxed max-w-xl text-left lg:mx-0">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 max-w-xl  lg:mx-0">
          ...
          <div className="flex justify-center lg:justify-end ">
            <img
              ...
              className="w-full max-w-md sm:max-w-2xl rounded-3xl shadow-xl object-cover"
            />
          </div>
        </div>
      </div>
