      ...
      <div className="w-full max-w-md bg-white rounded-3xl shadow-xl p-8">
        ...
        <div className="text-left mb-8">
          ...
          <p className="text-lg text-[#414141] mt-2">
            Log in to manage your insole designs
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3.5 rounded-2xl border border-gray-300 focus:border-[#009FF2] focus:ring-2 focus:ring-[#009FF2] outline-none transition-all placeholder:text-gray-400"
            />
            {errors.email && (
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full px-4 py-3.5 rounded-2xl border border-gray-300 focus:border-[#009FF2] focus:ring-2 focus:ring-[#009FF2] outline-none transition-all pr-12 placeholder:text-gray-400"
            />
            <button
              type="button"
          ...
          <div className="flex items-center justify-between">
            ...
            <Link
              to="/forgot-password"
              className="text-sm text-[#009FF2] hover:underline">
              Forgot password?
            </Link>
          </div>
        ...
        <p className="text-center mt-8 text-gray-600">
          ...
          <Link
            to="/signup"
            className="text-[#009FF2] font-medium hover:underline">
            Create an account
          </Link>
        </p>
      </div>
